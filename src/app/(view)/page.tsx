...
export default function Home() {
  ...
  return (
    <>
      <div
        className="h-[calc(100dvh-64px)] bg-zinc-200 grid lg:grid-cols-2 bg-center bg-no-repeat bg-contain lg:bg-size-[70dvh]"
      ...
      >
        <div className="!py-12 !px-4 lg:!p-12">
          ...
          <div className="w-full max-w-xl !mt-8">
            <div className="flex flex-wrap md:flex-nowrap justify-start items-center gap-3 bg-background !p-2 rounded-lg">
              <Input
                className="flex-1 min-w-0 bg-background !outline-0 !border-0 !ring-0"
            ...
            <div className="!mt-2 lg:!mt-6 flex flex-wrap gap-2">
              {badges.map((x, i) => (
        ...
        <div className="relative !p-6 overflow-hidden hidden lg:block">
          <div
      ...
      <div className="!py-12">
        <h3 className="text-xl lg:text-3xl text-center font-semibold !px-4">
          3000+ brands and agencies work with our creators
        </h3>
        <div className="w-full grid grid-cols-3 lg:grid-cols-6 !px-6 gap-6">
      ...
      <div className="!pb-12">
        <h2 className="!px-4 text-2xl lg:text-5xl font-bold text-center">
        ...
        <div className="w-full flex flex-row justify-center items-center">
          <div className="w-[90%] lg:w-4/5 grid lg:grid-cols-2 gap-6">
        ...
        <div className="!py-12">
          ...
          <div className="!pt-12 w-full">
            <div className="w-4/5 grid lg:grid-cols-2 !mx-auto gap-6">
                ...
                {Array.from({ length: 3 }).map((_, i) => (
                  ...
                  >
                    <AccordionItem value="item-1">
                      <AccordionTrigger className="!p-6 lg:text-xl">
